...
export default defineSchema({
    ...
    chat: defineTable({
        ...
        .index("by_userId_createdAt", ["userId", "_creationTime"]) // For fetching user's chats sorted by time
        .index("by_createdAt", ["_creationTime"]), // For fetching recent chats across all users (admin view)
    ...
    messages: defineTable({
        ...
        .index("by_chatId_createdAt", ["chatId", "_creationTime"]), // Crucial for fetching messages for a chat, sorted
});
